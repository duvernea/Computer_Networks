...
if (typeof janrain.settings.common.appUrl === 'undefined')janrain.settings.common.appUrl = "https://login.cmgdigital.com";
...
if (typeof janrain.settings.width === 'undefined')janrain.settings.width = "147";
...
if (typeof janrain.settings.fontColor === 'undefined')janrain.settings.fontColor = "#0a0909";
...
if (typeof janrain.settings.borderRadius === 'undefined')janrain.settings.borderRadius = "1";
if (typeof janrain.settings.appId === 'undefined')janrain.settings.appId = "acgbmfmhondnbilockca";
if (typeof janrain.settings.appUrl === 'undefined')janrain.settings.appUrl = "https://login.cmgdigital.com";
janrain.settings.permissions = ["customizable_auth_widget_hide_attribution","customizable_auth_widget_styling"];
if (typeof janrain.settings.providers === 'undefined')janrain.settings.providers = ["facebook","twitter","googleplus","yahoo"];
if (typeof janrain.settings.noReturnExperience === 'undefined')janrain.settings.noReturnExperience = false;
if (typeof janrain.settings.facebookAppId === 'undefined')janrain.settings.facebookAppId = "389610937776912";
...
if (typeof janrain.settings.share.elementHoverBackgroundColor === 'undefined')janrain.settings.share.elementHoverBackgroundColor = "#ffffff";
...
if (typeof janrain.settings.share.appUrl === 'undefined')janrain.settings.share.appUrl = "https://login.cmgdigital.com";
...
if (typeof janrain.settings.share.providers === 'undefined')janrain.settings.share.providers = [
	...
	'native-twitter',
	'native-linkedin'];
if (typeof janrain.settings.share.providersEmail === 'undefined')janrain.settings.share.providersEmail = ["googleplus","yahoo"];
...
var a2kScriptUrl = 'https://d6uon097akywu.cloudfront.net/jra2k-v1.js';
_loadDynamicScript(a2kScriptUrl, function() {
    var appId = janrain.settings.capture.appId || janrain.settings.capture.appid;
    janrain.settings.analytics.beforeJanrainCaptureWidgetOnLoad = janrain.settings.analytics.beforeJanrainCaptureWidgetOnLoad || [];
    janrain.settings.analytics.beforeJanrainCaptureWidgetOnLoad.push(
        window.janrain.analytics.anonymous.bindJanrainWidgetEvents
    );
});
