[13197:13202:3912625500:WARNING:proxy_service.cc(889)] PAC support disabled because there is no system implementation

(test_shell:13197): IBUS-WARNING **: The owner of /home/mininet/.config/ibus/bus is not root!
...
strt (ms) | end (ms)  | len (ms)  | err | url:port -> address_list
   87.336 |    87.445 |     0.109 |   0 | www.chipublib.org:80 ->  10.0.0.1:8000
   87.442 |    87.442 |     0.000 |   1 | www.chipublib.org:80 ->  nil
</resolves>

<transactions>
strt (ms) | end (ms)  | len (ms)  | url
   87.251 |   707.199 |   619.948 | http://www.chipublib.org/
</transactions>
...
Histogram: Net.HttpJob.TotalTime recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
533  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
633  ... 

Histogram: Net.HttpJob.TotalTimeNotCached recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
533  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
633  ... 

Histogram: Net.HttpJob.TotalTimeSuccess recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
533  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
633  ... 
...
Histogram: Net.HttpTimeToFirstByte recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
585  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
718  ... 
...
Histogram: Net.Transaction_Latency_Total recorded 1 samples, average = 619.0 (flags = 0x1)
0    ... 
572  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
648  ... 

Histogram: Net.Transaction_Latency_Total_New_Connection recorded 1 samples, average = 619.0 (flags = 0x1)
0    ... 
572  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
648  ... 

Histogram: Net.Transaction_Latency_b recorded 1 samples, average = 619.0 (flags = 0x1)
0    ... 
572  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
648  ... 
