[13212:13217:3913378254:WARNING:proxy_service.cc(889)] PAC support disabled because there is no system implementation

(test_shell:13212): IBUS-WARNING **: The owner of /home/mininet/.config/ibus/bus is not root!
...
strt (ms) | end (ms)  | len (ms)  | err | url:port -> address_list
   89.599 |    89.714 |     0.115 |   0 | blog.vandalog.com:80 ->  10.0.0.3:8000
   89.712 |    89.712 |     0.000 |   1 | blog.vandalog.com:80 ->  nil
</resolves>

<transactions>
strt (ms) | end (ms)  | len (ms)  | url
   89.555 |   710.708 |   621.153 | http://blog.vandalog.com/
</transactions>
...
Histogram: Net.HttpJob.TotalTime recorded 1 samples, average = 622.0 (flags = 0x1)
0    ... 
533  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
633  ... 

Histogram: Net.HttpJob.TotalTimeNotCached recorded 1 samples, average = 622.0 (flags = 0x1)
0    ... 
533  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
633  ... 

Histogram: Net.HttpJob.TotalTimeSuccess recorded 1 samples, average = 622.0 (flags = 0x1)
0    ... 
533  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
633  ... 
...
Histogram: Net.HttpTimeToFirstByte recorded 1 samples, average = 621.0 (flags = 0x1)
0    ... 
585  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
718  ... 
...
Histogram: Net.Transaction_Latency_Total recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
572  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
648  ... 

Histogram: Net.Transaction_Latency_Total_New_Connection recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
572  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
648  ... 

Histogram: Net.Transaction_Latency_b recorded 1 samples, average = 620.0 (flags = 0x1)
0    ... 
572  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
648  ... 
