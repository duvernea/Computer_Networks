[12823:12828:3905261978:WARNING:proxy_service.cc(889)] PAC support disabled because there is no system implementation

(test_shell:12823): IBUS-WARNING **: The owner of /home/mininet/.config/ibus/bus is not root!
...
strt (ms) | end (ms)  | len (ms)  | err | url:port -> address_list
   92.869 |    93.061 |     0.192 |   0 | www.chipublib.org:80 ->  10.0.0.1:8000
   93.057 |    93.057 |     0.000 |   1 | www.chipublib.org:80 ->  nil
</resolves>

<transactions>
strt (ms) | end (ms)  | len (ms)  | url
   92.798 |   198.575 |   105.777 | http://www.chipublib.org/
</transactions>
...
Histogram: Net.HttpJob.TotalTime recorded 1 samples, average = 107.0 (flags = 0x1)
0   ... 
96  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
114 ... 

Histogram: Net.HttpJob.TotalTimeNotCached recorded 1 samples, average = 107.0 (flags = 0x1)
0   ... 
96  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
114 ... 

Histogram: Net.HttpJob.TotalTimeSuccess recorded 1 samples, average = 107.0 (flags = 0x1)
0   ... 
96  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
114 ... 
...
Histogram: Net.HttpTimeToFirstByte recorded 1 samples, average = 107.0 (flags = 0x1)
0   ... 
92  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
113 ... 
...
Histogram: Net.Transaction_Latency_Total recorded 1 samples, average = 105.0 (flags = 0x1)
0    ... 
100  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
113  ... 

Histogram: Net.Transaction_Latency_Total_New_Connection recorded 1 samples, average = 105.0 (flags = 0x1)
0    ... 
100  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
113  ... 
