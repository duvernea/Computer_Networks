[12328:12333:3896203919:WARNING:proxy_service.cc(889)] PAC support disabled because there is no system implementation

(test_shell:12328): IBUS-WARNING **: The owner of /home/mininet/.config/ibus/bus is not root!
...
strt (ms) | end (ms)  | len (ms)  | err | url:port -> address_list
   79.692 |    79.799 |     0.107 |   0 | www.chipublib.org:80 ->  10.0.0.1:8000
   79.797 |    79.797 |     0.000 |   1 | www.chipublib.org:80 ->  nil
</resolves>

<transactions>
strt (ms) | end (ms)  | len (ms)  | url
   79.650 |   153.329 |    73.679 | http://www.chipublib.org/
</transactions>
...
Histogram: Net.HttpJob.TotalTime recorded 1 samples, average = 74.0 (flags = 0x1)
0   ... 
68  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
81  ... 

Histogram: Net.HttpJob.TotalTimeNotCached recorded 1 samples, average = 74.0 (flags = 0x1)
0   ... 
68  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
81  ... 

Histogram: Net.HttpJob.TotalTimeSuccess recorded 1 samples, average = 74.0 (flags = 0x1)
0   ... 
68  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
81  ... 
...
Histogram: Net.HttpTimeToFirstByte recorded 1 samples, average = 74.0 (flags = 0x1)
0   ... 
61  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
75  ... 
...
Histogram: Net.Transaction_Latency_Total recorded 1 samples, average = 73.0 (flags = 0x1)
0   ... 
69  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
78  ... 

Histogram: Net.Transaction_Latency_Total_New_Connection recorded 1 samples, average = 73.0 (flags = 0x1)
0   ... 
69  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
78  ... 

Histogram: Net.Transaction_Latency_b recorded 1 samples, average = 73.0 (flags = 0x1)
0   ... 
69  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
78  ... 
