[13257:13262:3915249798:WARNING:proxy_service.cc(889)] PAC support disabled because there is no system implementation

(test_shell:13257): IBUS-WARNING **: The owner of /home/mininet/.config/ibus/bus is not root!
...
strt (ms) | end (ms)  | len (ms)  | err | url:port -> address_list
   92.297 |    92.409 |     0.112 |   0 | www.chipublib.org:80 ->  10.0.0.1:8000
   92.407 |    92.407 |     0.000 |   1 | www.chipublib.org:80 ->  nil
</resolves>

<transactions>
strt (ms) | end (ms)  | len (ms)  | url
   92.252 |   301.538 |   209.286 | http://www.chipublib.org/
</transactions>
...
Histogram: Net.HttpJob.TotalTime recorded 1 samples, average = 210.0 (flags = 0x1)
0    ... 
190  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
226  ... 

Histogram: Net.HttpJob.TotalTimeNotCached recorded 1 samples, average = 210.0 (flags = 0x1)
0    ... 
190  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
226  ... 

Histogram: Net.HttpJob.TotalTimeSuccess recorded 1 samples, average = 210.0 (flags = 0x1)
0    ... 
190  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
226  ... 
...
Histogram: Net.HttpTimeToFirstByte recorded 1 samples, average = 210.0 (flags = 0x1)
0    ... 
210  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
258  ... 
...
Histogram: Net.Transaction_Latency_Total recorded 1 samples, average = 208.0 (flags = 0x1)
0    ... 
186  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
211  ... 

Histogram: Net.Transaction_Latency_Total_New_Connection recorded 1 samples, average = 208.0 (flags = 0x1)
0    ... 
186  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
211  ... 

Histogram: Net.Transaction_Latency_b recorded 1 samples, average = 208.0 (flags = 0x1)
0    ... 
186  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
211  ... 
