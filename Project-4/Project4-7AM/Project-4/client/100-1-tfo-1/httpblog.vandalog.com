[13272:13277:3915594724:WARNING:proxy_service.cc(889)] PAC support disabled because there is no system implementation

(test_shell:13272): IBUS-WARNING **: The owner of /home/mininet/.config/ibus/bus is not root!
...
strt (ms) | end (ms)  | len (ms)  | err | url:port -> address_list
   89.902 |    90.012 |     0.110 |   0 | blog.vandalog.com:80 ->  10.0.0.3:8000
   90.009 |    90.009 |     0.000 |   1 | blog.vandalog.com:80 ->  nil
</resolves>

<transactions>
strt (ms) | end (ms)  | len (ms)  | url
   89.860 |   298.696 |   208.836 | http://blog.vandalog.com/
</transactions>
...
Histogram: Net.HttpJob.TotalTime recorded 1 samples, average = 209.0 (flags = 0x1)
0    ... 
190  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
226  ... 

Histogram: Net.HttpJob.TotalTimeNotCached recorded 1 samples, average = 209.0 (flags = 0x1)
0    ... 
190  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
226  ... 

Histogram: Net.HttpJob.TotalTimeSuccess recorded 1 samples, average = 209.0 (flags = 0x1)
0    ... 
190  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
226  ... 
...
Histogram: Net.HttpTimeToFirstByte recorded 1 samples, average = 208.0 (flags = 0x1)
0    ... 
171  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
210  ... 
...
Histogram: Net.Transaction_Latency_Total recorded 1 samples, average = 207.0 (flags = 0x1)
0    ... 
186  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
211  ... 

Histogram: Net.Transaction_Latency_Total_New_Connection recorded 1 samples, average = 207.0 (flags = 0x1)
0    ... 
186  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
211  ... 

Histogram: Net.Transaction_Latency_b recorded 1 samples, average = 207.0 (flags = 0x1)
0    ... 
186  ------------------------------------------------------------------------O (1 = 100.0%) {0.0%}
211  ... 
