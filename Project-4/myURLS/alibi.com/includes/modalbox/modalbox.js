...
// johnm@alibi local-only mod
//   selected: "true" crap for our weirdo iui-derived styling. *damn* I regret ever touching that stuff.
//   also setting z-index in element attribute instead of counting on the css to do it; fixes a mobile safari bug
...
Modalbox.Methods = {
	...
	_init: function(options) {
		...
		this.MBoverlay = new Element("div", {id: "MB_overlay", style: "opacity: 0; z-index: 9999;", selected: "true"});

		// Creating the modal window
		this.MBwindowwrapper = new Element("div", {id: "MB_windowwrapper", selected: "true", style:'z-index: 10000;'}).update(
